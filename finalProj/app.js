...
const app = express();
 ...
 const {getHome, getItem, getSellerPage, getSeller, addSellerPage, addSeller, deleteSeller, deleteItem, addItemPage, addItem, addBuy, userLogin, userReg, getBuy, signup, login, goPurchase, makePurchase} = require('./routes/index');
